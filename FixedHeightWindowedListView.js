...
export default class FixedHeightWindowedListView extends Component {
  constructor(props, context) {
    ...
    this.__enqueueComputeRowsToRender = this.__enqueueComputeRowsToRender.bind(
      this
    )
  ...
  scrollToSectionBuffered(sectionId) {
    if (
      ...
      this.props.dataSource.hasSection(sectionId)
    ) {
      let { row, startY } = this.props.dataSource.getFirstRowOfSection(
        sectionId
      )
  ...
  __computeRowsToRenderSync(props, forceUpdate = false) {
    ...
    let {
      ...
      targetFirstRow,
      targetLastRow
    } = dataSource.computeRowsToRender({
      scrollDirection,
      firstVisible,
      lastVisible,
  ...
  __calculateSpacers() {
    ...
    if (bufferFirstRow !== null && bufferFirstRow < firstRow) {
      spacerMidHeight = this.props.dataSource.getHeightBetweenRows(
        bufferLastRow,
        firstRow
      )
      ...
      spacerTopHeight = spacerTopHeight - (spacerMidHeight + bufferHeight)
      ...
      spacerBottomHeight = spacerBottomHeight - spacerMidHeight
    }
